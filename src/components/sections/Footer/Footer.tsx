...
export const Footer = () => {
  ...
  return (
    <footer className="flex flex-col sm:flex-row items-start sm:items-center justify-start sm:justify-between w-full px-8 xl:px-36 py-8 mt-16 gap-8 bg-header-footer-light dark:bg-brown-dark shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
      <Link
        to="/"
